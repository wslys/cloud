...
func (o *Oauth2) Token(ctx context.Context, req *oauth2.TokenRequest, rsp *oauth2.TokenResponse) error {
	...
	case "authorization_code":
		fmt.Println("Go In  authorization_code >>>>>>>>>>>. ")
		// validate inputs
